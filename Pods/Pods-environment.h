...
// GSKeychain
#define COCOAPODS_POD_AVAILABLE_GSKeychain
#define COCOAPODS_VERSION_MAJOR_GSKeychain 1
#define COCOAPODS_VERSION_MINOR_GSKeychain 0
#define COCOAPODS_VERSION_PATCH_GSKeychain 0
