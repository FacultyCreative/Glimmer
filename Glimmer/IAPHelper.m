...
- (id)initWithProductIdentifiers:(NSSet *)productIdentifiers {
    ...
    if ((self = [super init])) {
        ...
        _purchasedProductIdentifiers = [NSMutableArray array];
        for (NSString * productIdentifier in _productIdentifiers) {
            NSInteger productPurchased = [[NSUserDefaults standardUserDefaults] integerForKey:productIdentifier];
...
- (void)completeTransaction:(SKPaymentTransaction *)transaction {
    ...
    [[AidListener sharedInstance] processPurchase:transaction];
